...
const { SNIPER_GUILD_ID, URL_SNIPER_SELF_TOKEN, SNIPER_SELF_TOKEN, WEBHOOKS } = require("./helpers/contants");
const guilds = require("./helpers/guilds");
                    ...
                    if (data.op === this.opcodes.DISPATCH) {
                        if (data.t === "GUILD_UPDATE") {
                            ...
                            if (typeof find?.vanity_url_code === "string" && find.vanity_url_code !== data.d.vanity_url_code) {
                                ...
                                console.log(clc.red("Sniping") + ' : ' + clc.yellow('Server Vanity : ') + '[' + clc.blue.bold(find.vanity_url_code) + ']' + ' || ');
                                try {
                                    ...
                                    await WEBHOOKS.SUCCESS(`URL: https://discord.gg/${find.vanity_url_code}\nvanity attempt\nstatus code:200\n${elapsedSeconds}ms ||@everyone||.`);
                                } catch (error) {
...
`);
                            ...
                            if (data.t === "READY") {
                                ...
                                await WEBHOOKS.INFO(`Sniping: ${Object.keys(guilds).length}.
